...
function DemoLogin() {
  ...
  const handleSubmit = async(event) => {
    ...
    try{
   //await axios.post("http://localhost:9200/api/auth/signin", loginCred,{withCredentials: true}).then((response) => {
    await axios.post("http://ascend-pgp-team2.eastus.cloudapp.azure.com:8765/api/auth/signin", loginCred,{withCredentials: true}).then((response) => {
